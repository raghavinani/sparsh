...
class _NavigationView extends State<NavigationView> {
  ...
  void initState() {
    super.initState();
    durationAnimation = widget.durationAnimation ?? durationAnimation;
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: AnimatedContainer(
                                    duration: Duration(
                                      milliseconds:
                                          durationAnimation.inMilliseconds ~/ 2,
                                    ),
                                    width: double.maxFinite,
                                    height: 4,
                                    decoration: BoxDecoration(
                                ...
                                .map(
                                  (e) => Flexible(
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        setState(() {
                                          _currentPage = widget.items.indexOf(
                                            e,
                                          );
                                          widget.onChangePage.call(
